...
function getInstance(value) {
  var Foobar = /*#__PURE__*/function (_ImportPart) {
    _inherits(Foobar, _ImportPart);
    var _super = _createSuper(Foobar);
    function Foobar() {
      _classCallCheck(this, Foobar);
      return _super.apply(this, arguments);
    }
    return _createClass(Foobar);
  }(ImportPart);
...
it('should throw with wrong value', function () {
  expect(function () {
    return getInstance();
  }).toThrowError('Foobar: value should be a string');
});
it('should have proper tag', function () {
  expect(Object.prototype.toString.call(getInstance('foo'))).toBe('[object Foobar]');
});
