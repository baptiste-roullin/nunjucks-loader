 ...
 */
export function getUsedDependencies(_x, _x2, _x3, _x4, _x5) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return Promise.all([getTemplatesImports(loaderContext, nodes, searchPaths), getAssets(nodes, assetsPaths), getAddonsMeta(globals, {
            es: esModule,
            type: 'globals',
