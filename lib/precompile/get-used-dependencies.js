 ...
 */
function getUsedDependencies(_x, _x2, _x3, _x4, _x5) {
  return _getUsedDependencies.apply(this, arguments);
}
function _getUsedDependencies() {
  _getUsedDependencies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(loaderContext, nodes, extensions, filters, loaderOptions) {
    var searchPaths, assetsPaths, globals, esModule, _yield$Promise$all, _yield$Promise$all2, templates, assets, _globals;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          searchPaths = loaderOptions.searchPaths, assetsPaths = loaderOptions.assetsPaths, globals = loaderOptions.globals, esModule = loaderOptions.esModule;
          _context.next = 3;
          return Promise.all([(0, _getTemplatesImports.getTemplatesImports)(loaderContext, nodes, searchPaths), (0, _getAssets.getAssets)(nodes, assetsPaths), (0, _getAddonsMeta.getAddonsMeta)(globals, {
            es: esModule,
            type: 'globals',
        ...
        case 3:
          ...
          templates = _yield$Promise$all2[0];
          assets = _yield$Promise$all2[1];
          _globals = _yield$Promise$all2[2];
          return _context.abrupt("return", {
            templates: templates,
            globals: (0, _getUsedGlobals.getUsedGlobals)(nodes, _globals),
