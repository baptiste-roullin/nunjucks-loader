...
function getTemplatesImports(loaderContext, nodes, searchPaths) {
  var templateDeps = (0, _getDependenciesTemplates.getDependenciesTemplates)(nodes).filter(function (dep) {
  ...
  var possiblePaths = (0, _getPossiblePaths.getPossiblePaths)(templateDeps, searchPaths);
