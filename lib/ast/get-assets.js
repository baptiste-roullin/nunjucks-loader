    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return (0, _getFirstExistedPath.getFirstExistedPath)(paths);
        case 4:
        ...
        case 8:
          ...
          if (!(_context.t0.code !== _constants.ERROR_MODULE_NOT_FOUND)) {
            _context.next = 12;
            break;
          }
...
function getAssets(nodes, searchAssets) {
  var assets = (0, _getNodesValues.getNodesValues)(nodes, _nunjucks["default"].nodes.CallExtensionAsync, getNodeValue).filter(_isUniqueAsset.isUniqueAsset);
  var possiblePaths = (0, _getPossiblePaths.getPossiblePaths)(assets, [].concat(searchAssets));
